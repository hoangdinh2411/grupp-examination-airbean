...
export default function About() {
  ...
  <div className='wrapper'>
    ...
    <p className='wrapper__upperText'>
    ...
    <p className='wrapper__lowerText'>
    ...
    <section className='wrapper__profile'>
      <img src={cortado} alt="Eva Cortado" />
      <h2 className='wrapper__profile__name'>Eva Cortado</h2>
      <p className='wrapper__profile__info'>VD & Grundare</p>
    </section>
